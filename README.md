...
- The installation and runcom setup is
  [tested weekly on real Ubuntu and macOS machines](https://github.com/aaricpittman/dotfiles/actions)
...
```bash
bash -c "`curl -fsSL https://raw.githubusercontent.com/aaricpittman/dotfiles/master/remote-install.sh`"
```
...
```bash
git clone https://github.com/aaricpittman/dotfiles.git ~/.dotfiles
```
...
[GitHub Action](https://github.com/aaricpittman/dotfiles/actions).
